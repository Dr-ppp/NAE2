...
public abstract class ExtremeCell<T extends IAEStack<T>> extends AEBaseItem implements IExtremeStorageCell<T>,
        IItemGroup {
    ...
    public ExtremeCell(Materials.MaterialType whichCell, long bytes) {
    ...
    @Override
    public long getBytes(@NotNull ItemStack cellItem) {
